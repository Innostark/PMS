...
using OSS.Web.ViewModels.Domain;
...
namespace IdentitySample.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public ActionResult Users(UserSearchRequest userSearchRequest)
        {
            ...
            IEnumerable<OSS.Web.Models.Users> usersList = users.Users.Select(x => x.CreateFrom(Session["RoleName"].ToString(),loggedInUserCompanyName)).ToList();
