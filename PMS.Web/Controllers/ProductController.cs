...
using PMS.Web.ViewModels.Products;
using Product = PMS.Web.Models.Product;
using ProductResponse = PMS.Models.ResponseModels.ProductResponse;
    ...
    public class ProductController : Controller
    {
        ...
        private ProductViewModel GetData(ProductSearchRequest request)
        {
            ...
            var productViewModel = new ProductViewModel
            {
             ...
             Products = new SelectList(Enumerable.Empty<PMS.Models.DomainModels.Product>(), "Id", "Name")//you can assume its a list of sub-categories
            };
        ...
        private IEnumerable<PMS.Models.DomainModels.Product> GetProducts(string request)
        {
            IEnumerable<PMS.Models.DomainModels.Product> products = productService.FindProductsByCategory(Convert.ToInt32(request));
